	...
	const allSongs = {
		...
		songs:[
			...
			{	title: 'Mountain Path',
				artist: 'Magnetic',
				duration: '3:28',
				url: '/assets/audio/mountain-path.mp3',
			...
			{	title: 'Please Calm My Mind',
				artist: 'Lesfm',
				duration: '2:55',
				url: '/assets/audio/please-calm-my-mind.mp3',
			...
			{	title: 'Password Infinity',
				artist: 'Evgeny',
				duration: '2:25',
				url: '/assets/audio/password-infinity.mp3',
			...
			{	title: 'The Beat of Nature',
				artist: 'Olexy',
				duration: '2:53',
				url: '/assets/audio/the-beat-of-nature.mp3',
			...
			{	title: 'Best Time',
				artist: 'FASS',
				duration: '2:08',
				url: '/assets/audio/best-time.mp3',
			...
			{	title: 'Sweet Love',
				artist: 'Dayfox',
				duration: '3:13',
				url: '/assets/audio/sweet-love.mp3',
			...
			{	title: 'Into The Night',
				artist: 'Prazkhanal',
				duration: '2:16',
				url: '/assets/audio/into-the-night.mp3',
